...
export default class EnnemyPlaneMissile extends Weapon implements IHtmlElementInterface  {
    ...
    build(container: SquareContainer): void {
        this.htmlElement = document.querySelector<HTMLImageElement>('.ennemyPlaneMissile')!
        let containerElt = container.getHtmlElement();
        this.htmlElement = document.createElement("img");
        this.htmlElement.classList.add("ennemyPLaneMissile");
        this.htmlElement.src = "/assets/projectiles/ennemyMissile.png"
